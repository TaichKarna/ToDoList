...
(0,date_fns__WEBPACK_IMPORTED_MODULE_4__.format)(new Date(2014, 1, 11), "yyyy-MM-dd");

const date1 = "2024 01 06";
const task1 = new _modules_task__WEBPACK_IMPORTED_MODULE_1__.Task("task1","demo task",date1,"high");

const newList = (0,_modules_localStorage__WEBPACK_IMPORTED_MODULE_3__.localMemory)();
...
{   
    const reCreate = (toDoList) => {
        ...
        for(let project of toDoList){
            const newProject = new _project__WEBPACK_IMPORTED_MODULE_1__.Project(project.title); 
            const taskList = project.task;    
            
            for(let task of taskList){
                const newTask = new _task__WEBPACK_IMPORTED_MODULE_0__.Task(task.title,task.description,task.dueDate,task.priority,
                    task.status);
    ...
    const getList = () => {
        ...
        if(!localStorage.getItem("ToDoList")){
            const toDoList = [];
            const defautProject = new _project__WEBPACK_IMPORTED_MODULE_1__.Project("default")
