...
*/
  ...
  \**********************/
      /***/ (
        ...
        /* harmony import */ var _modules_task__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ./modules/task */ "./src/modules/task.js");
        /* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(
            /*! date-fns */ "./node_modules/date-fns/format.mjs",
          );
        /* harmony import */ var _modules_project__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ./modules/project */ "./src/modules/project.js",
          );
        /* harmony import */ var _modules_localStorage__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! ./modules/localStorage */ "./src/modules/localStorage.js",
          );

        (0, date_fns__WEBPACK_IMPORTED_MODULE_4__.format)(
          new Date(2014, 1, 11),
          "yyyy-MM-dd",
        );

        const date1 = "2024 01 06";
        const task1 = new _modules_task__WEBPACK_IMPORTED_MODULE_1__.Task(
          "task1",
          "demo task",
          date1,
          "high",
        ...
        const newList = (0,
        _modules_localStorage__WEBPACK_IMPORTED_MODULE_3__.localMemory)();
  ...
  \*************************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ localMemory: () => /* binding */ localMemory,
          /* harmony export */ localStorageHandler: () =>
            /* binding */ localStorageHandler,
          /* harmony export */
        });
        ...
        function localStorageHandler() {
          const reCreate = (toDoList) => {
            ...
            for (let project of toDoList) {
              const newProject =
                new _project__WEBPACK_IMPORTED_MODULE_1__.Project(
                  project.title,
                );
          ...
          const getList = () => {
            if (!localStorage.getItem("ToDoList")) {
              const toDoList = [];
              const defautProject =
                new _project__WEBPACK_IMPORTED_MODULE_1__.Project("default");
          ...
          return { getList, addtoStorage, addTask };
        }
  ...
  \******************************************/
      /***/ (
        ...
        /* harmony import */ var _isValid_mjs__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! ./isValid.mjs */ "./node_modules/date-fns/isValid.mjs",
          );
        /* harmony import */ var _toDate_mjs__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
        ...
        /* harmony import */ var _lib_format_formatters_mjs__WEBPACK_IMPORTED_MODULE_5__ =
          __webpack_require__(
            /*! ./_lib/format/formatters.mjs */ "./node_modules/date-fns/_lib/format/formatters.mjs",
          );
        /* harmony import */ var _lib_format_longFormatters_mjs__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(
        ...
        function format(date, formatStr, options) {
          ...
          _toDate_mjs__WEBPACK_IMPORTED_MODULE_2__.toDate)(date);

          if (
            !(0, _isValid_mjs__WEBPACK_IMPORTED_MODULE_3__.isValid)(
              originalDate,
            )
          ) {
          ...
          const result = formatStr
            ...
            .map(function (substring) {
              ...
              if (firstCharacter === "p" || firstCharacter === "P") {
                const longFormatter =
                  _lib_format_longFormatters_mjs__WEBPACK_IMPORTED_MODULE_4__
            ...
            .map(function (substring) {
              ...
              const formatter =
                _lib_format_formatters_mjs__WEBPACK_IMPORTED_MODULE_5__
              ...
              if (formatter) {
                if (
                  ...
                  (0,
                  _lib_protectedTokens_mjs__WEBPACK_IMPORTED_MODULE_6__.throwProtectedError)(
                    substring,
                    formatStr,
                    String(date),
                  );
